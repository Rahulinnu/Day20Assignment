    ...
    public class UserRegistrationReflector
    {
        ...
        public string InvokeMethod(string input, string methodName) // creating a method for invoking method
        {
            try
            {
                ...
                object validationObject = CreateValidationParameterizedObject("UserRegistrationWithExceptionAndReflection.Validation", "Validation", input);//Creating a parameterized object of Validation class using reflection
