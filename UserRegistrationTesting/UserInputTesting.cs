...
using UserRegistrationWithExceptionAndReflection;
using System;
...
namespace UserRegistrationTesting
{
    ...
    public class UserInputTesting
    {
        ...
        public void GivenClassNameShoulReturnObject()
        {
            ...
            object actual = userRegistrationReflector.CreateValidationObject("UserRegistrationWithExceptionAndReflection.Validation", "Validation");
        ...
        public void GivenInvalidClassThrowException()
        {
            ...
            {
                object expected = new Validation();
                object actual = userRegistrationReflector.CreateValidationObject("UserRegistrationWithExceptionAndReflection.valid", "valid");
            }
        ...
        public void GivenClassNameShoulReturnParameterizedObject()
        {
            ...
            object actual = userRegistrationReflector.CreateValidationParameterizedObject("UserRegistrationWithExceptionAndReflection.Validation", "Validation", input);
            expected.Equals(actual);
        }
        ...
        public void GivenInvalidClassNameWithMessageThrowException()
        {
            try
            {
                string input = "Madhavee";
                object expected = new Validation(input);
                object actual = userRegistrationReflector.CreateValidationParameterizedObject("UserRegistrationWithExceptionAndReflection.valid", "valid", input);
            }
            catch (InvalidException ex)
            {
                Assert.AreEqual("Class not found", ex.Message);
